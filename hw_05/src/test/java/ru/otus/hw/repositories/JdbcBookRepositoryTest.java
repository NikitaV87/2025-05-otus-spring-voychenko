...
class JdbcBookRepositoryTest {
    ...
    @DisplayName("должен выдать исключение при обновления не существующей записи")
    @Test
    void shouldTrowOnExceptDelete() {
        var expectedBook = new Book(99, "BookTitle_10500", dbAuthors.get(0),
                List.of(dbGenres.get(0), dbGenres.get(2)));
        Assertions.assertThrows(EntityNotFoundException.class, () -> {repositoryJdbc.save(expectedBook);});
    }
