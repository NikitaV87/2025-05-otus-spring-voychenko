...
public class CommentServiceImpTest {
    ...
    private Map<String, Comment> commentsById;

    private Map<String, List<Comment>> commentsByBookId;

    public static final String BOOK_ID_WITH_COMMENTS = "1";

    public static final String FOR_NEW_COMMENT_TEXT = "NEW_TEXT";

    public static final String FOR_NEW_COMMENT_BOOK_ID = "1";

    public static final String FOR_UPD_COMMENT_TEXT = "UPD_TEXT";

    public static final String FOR_UPD_COMMENT_ID = "1";

    public static final String FOR_DEL_COMMENT_ID = "2";

    private static final Map<String, String> BOOK_ID_CONTAINS_AUTHOR_ID = Map.of("1","1", "2", "2", "3", "3");

    private static final Map<String, List<String>> COMMENT_ID_BY_BOOK_ID = Map.of("1", List.of("1", "2", "3"),
            "2", List.of("4"));
    ...
    private static Map<String, Comment> getComments() {
        List<Comment> allComment = new ArrayList<>();

        for (String bookId: COMMENT_ID_BY_BOOK_ID.keySet()) {
    ...
    static private Map<String, List<Comment>> getGroupByBookId(List<Comment> comments) {
        return comments.stream()
                .collect(Collectors.groupingBy(c -> c.getBook().getId()));
    }

    static private List<String> getCommentIds() {
        return LongStream.range(1, 5).boxed().map(Object::toString).toList();
    }
}
