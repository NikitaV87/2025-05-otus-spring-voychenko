...
public class CommentRepositoryTest {
    ...
    void findByIdTest(Long id) {
        Comment expectedCommentBook = em.find(Comment.class, id);
        Optional<Comment> actualCommentBook = commentRepository.findById(id);
    ...
    @Test
    void deleteTest() {
        Comment bookCommentForDelete = em.find(Comment.class, ID_COMMENT_BOOK_FOR_DELETE);
